...
const initJwtConfig = async () => {
  ...
  try {
    ...
    const { private: privateKey, public: publicKey } = await KeyStoreService.getOrCreateRSAKeys();
    ...
    console.log('JWT configuration initialized with RSA keys from database');
